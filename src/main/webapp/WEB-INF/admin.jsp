...
<body class="bg-dark">
	...
	<div class="d-flex flex-column justify-content-center align-items-center mt-5">
		<h3 class="mb-5 text-white">Admin Dashboard</h3>
	</div>
	<div class="container-fluid">
		...
		<table id="myTable" class="table table-striped align-middle border rounded overflow-hidden bg-gradient shadow">
			<thead>
				<tr>
					<th class="custom-bg-color">Username</th>
					<th class="custom-bg-color">First Name</th>
					<th class="custom-bg-color">Last Name</th>
					<th class="custom-bg-color">Email</th>	
					<th class="custom-bg-color">Actions</th>									
				</tr>
			</thead>
